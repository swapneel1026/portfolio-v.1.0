...
const HeroSection = () => {
  return (
    <div className="p-2 md:p-6 xl:max-w-6xl  flex flex-col flex-wrap justify-stretch h-screen ">
      ...
      <Link href={""}>
        <button
          className="bg-[#0aff9d] py-2 px-3 md:py-3 md:px-5 text-lg rounded-md mt-5 hover:brightness-90 hover:transition-all duration-200"
          type="button"
        >
          Contact me
        </button>
