...
const SideNavbar = () => {
  ...
  return (
    <div className="overflow-x-hidden sticky top-0 left-0 z-20 flex py-2 flex-col items-center  overflow-y-hiddn h-screen  min-w-[55px] max-w-[70px] text-lg font-[300] text-[#ebecf3] bg-[#000] ">
